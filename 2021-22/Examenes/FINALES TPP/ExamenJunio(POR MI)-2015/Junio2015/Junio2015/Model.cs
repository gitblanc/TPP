    ...
    public class Model {
        ...
        static void ResetModel() {
            ...
            employees = new List<Employee> {
			    ...
			    new Employee ("Dario", "Dariez", new DateTime(1973,12,16), "100 004", "dario@uniovi.es", "Asturias", offices[2]),
            ...
            departments = new List<Department> {
			    ...
			    new Department ( "Computer Science",new List<Employee> {employees[1], employees[3]}),
			    new Department ( "Medicine",new List<Employee> {employees[0]}),
			    new Department ( "Physics",new List<Employee> {employees[5]}),
    		    };

            employees[4].Department = departments[0];
            employees[1].Department = employees[3].Department = departments[1];
