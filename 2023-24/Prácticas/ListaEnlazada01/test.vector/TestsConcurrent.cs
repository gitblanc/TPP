...
namespace test.vector
{
    ...
    public class TestsConcurrent
    {
        ...
        {
            // ConcurrentBag representa una colección segura para subprocesos desordenada de objetos.
            // https://learn.microsoft.com/es-es/dotnet/api/system.collections.concurrent.concurrentbag-1?view=net-7.0
        ...
        {
            // ConcurrentDictionary representa una colección segura para subprocesos de los pares clave-valor a los que pueden obtener
            // acceso varios subprocesos a la vez.
            // https://learn.microsoft.com/es-es/dotnet/api/system.collections.concurrent.concurrentdictionary-2?view=net-7.0
